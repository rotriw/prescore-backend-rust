...
pub mod prescore {
    ...
    diesel::table! {
        /// Representation of the `prescore.times_number` table.
        ///
        /// (Automatically generated by Diesel.)
        prescore.times_number (id) {
            /// The `id` column of the `prescore.times_number` table.
            ///
            /// Its SQL type is `Int8`.
            ///
            /// (Automatically generated by Diesel.)
            id -> Int8,
            /// The `tid` column of the `prescore.times_number` table.
            ///
            /// Its SQL type is `Int8`.
            ///
            /// (Automatically generated by Diesel.)
            tid -> Int8,
            /// The `time` column of the `prescore.times_number` table.
            ///
            /// Its SQL type is `Int8`.
            ///
            /// (Automatically generated by Diesel.)
